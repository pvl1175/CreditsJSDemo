...
API_TransactionsStateGet_args.prototype.write = function(output) {
  ...
  if (this.id !== null && this.id !== undefined) {
    ...
    for (var iter135 in this.id) {
      if (this.id.hasOwnProperty(iter135)) {
        iter135 = this.id[iter135];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i138 = 0; _i138 < _size136; ++_i138) {
          var elem139 = null;
          elem139 = new ByteCodeObject();
          elem139.read(input);
          this.byteCodeObjects.push(elem139);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
API_ContractAllMethodsGet_args.prototype.write = function(output) {
  ...
  if (this.byteCodeObjects !== null && this.byteCodeObjects !== undefined) {
    ...
    for (var iter140 in this.byteCodeObjects) {
      if (this.byteCodeObjects.hasOwnProperty(iter140)) {
        iter140 = this.byteCodeObjects[iter140];
