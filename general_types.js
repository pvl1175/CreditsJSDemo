    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i24 = 0; _i24 < _size22; ++_i24) {
          var elem25 = null;
          elem25 = new MethodArgument();
          elem25.read(input);
          this.arguments.push(elem25);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
MethodDescription.prototype.write = function(output) {
  ...
  if (this.arguments !== null && this.arguments !== undefined) {
    ...
    for (var iter26 in this.arguments) {
      if (this.arguments.hasOwnProperty(iter26)) {
        iter26 = this.arguments[iter26];
        iter26.write(output);
      }
    }
    output.writeListEnd();
