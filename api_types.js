...
SmartContractInvocation.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    for (var iter9 in this.params) {
      if (this.params.hasOwnProperty(iter9)) {
        iter9 = this.params[iter9];
        iter9.write(output);
      }
    }
    output.writeListEnd();
...
SmartExecutionTransInfo.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    output.writeFieldBegin('params', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter14 in this.params) {
      if (this.params.hasOwnProperty(iter14)) {
        iter14 = this.params[iter14];
        iter14.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i17 = 0; _i17 < _size15; ++_i17) {
          ...
          var key18 = null;
          var val19 = null;
          key18 = input.readByte().value;
          val19 = new CumulativeAmount();
          val19.read(input);
          this.balancePerCurrency[key18] = val19;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
PeriodStats.prototype.write = function(output) {
  ...
  if (this.balancePerCurrency !== null && this.balancePerCurrency !== undefined) {
    ...
    for (var kiter20 in this.balancePerCurrency) {
      if (this.balancePerCurrency.hasOwnProperty(kiter20)) {
        var viter21 = this.balancePerCurrency[kiter20];
        output.writeByte(kiter20);
...
PoolListGetResult.prototype.write = function(output) {
  ...
  if (this.pools !== null && this.pools !== undefined) {
    ...
    for (var iter31 in this.pools) {
      if (this.pools.hasOwnProperty(iter31)) {
        iter31 = this.pools[iter31];
        iter31.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i34 = 0; _i34 < _size32; ++_i34) {
          var elem35 = null;
          elem35 = new SealedTransaction();
          elem35.read(input);
          this.transactions.push(elem35);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
PoolTransactionsGetResult.prototype.write = function(output) {
  ...
  if (this.transactions !== null && this.transactions !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
    for (var iter36 in this.transactions) {
      if (this.transactions.hasOwnProperty(iter36)) {
        iter36 = this.transactions[iter36];
        iter36.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i39 = 0; _i39 < _size37; ++_i39) {
          var elem40 = null;
          elem40 = new PeriodStats();
          elem40.read(input);
          this.stats.push(elem40);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
StatsGetResult.prototype.write = function(output) {
  ...
  if (this.stats !== null && this.stats !== undefined) {
    ...
    for (var iter41 in this.stats) {
      if (this.stats.hasOwnProperty(iter41)) {
        iter41 = this.stats[iter41];
        iter41.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i44 = 0; _i44 < _size42; ++_i44) {
          ...
          this.addressesList.push(elem45);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractAddressesListGetResult.prototype.write = function(output) {
  ...
  if (this.addressesList !== null && this.addressesList !== undefined) {
    ...
    for (var iter46 in this.addressesList) {
      if (this.addressesList.hasOwnProperty(iter46)) {
        iter46 = this.addressesList[iter46];
        output.writeBinary(iter46);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i49 = 0; _i49 < _size47; ++_i49) {
          var elem50 = null;
          elem50 = new SmartContract();
          elem50.read(input);
          this.smartContractsList.push(elem50);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractsListGetResult.prototype.write = function(output) {
  ...
  if (this.smartContractsList !== null && this.smartContractsList !== undefined) {
    ...
    for (var iter51 in this.smartContractsList) {
      if (this.smartContractsList.hasOwnProperty(iter51)) {
        iter51 = this.smartContractsList[iter51];
        iter51.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i54 = 0; _i54 < _size52; ++_i54) {
          ...
          var key55 = null;
          var val56 = null;
          key55 = input.readI64().value;
          val56 = input.readI32().value;
          this.states[key55] = val56;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TransactionsStateGetResult.prototype.write = function(output) {
  ...
  if (this.states !== null && this.states !== undefined) {
    ...
    for (var kiter57 in this.states) {
      if (this.states.hasOwnProperty(kiter57)) {
        var viter58 = this.states[kiter57];
        output.writeI64(kiter57);
...
SmartMethodParamsGetResult.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter63 in this.params) {
      if (this.params.hasOwnProperty(iter63)) {
        iter63 = this.params[iter63];
        iter63.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i66 = 0; _i66 < _size64; ++_i66) {
          var elem67 = null;
          elem67 = new MethodDescription();
          elem67.read(input);
          this.methods.push(elem67);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ContractAllMethodsGetResult.prototype.write = function(output) {
  ...
  if (this.methods !== null && this.methods !== undefined) {
    ...
    for (var iter68 in this.methods) {
      if (this.methods.hasOwnProperty(iter68)) {
        iter68 = this.methods[iter68];
        iter68.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i71 = 0; _i71 < _size69; ++_i71) {
          var elem72 = null;
          elem72 = new SmartContractMethodArgument();
          elem72.read(input);
          this.arguments.push(elem72);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractMethod.prototype.write = function(output) {
  ...
  if (this.arguments !== null && this.arguments !== undefined) {
    ...
    for (var iter73 in this.arguments) {
      if (this.arguments.hasOwnProperty(iter73)) {
        iter73 = this.arguments[iter73];
        iter73.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i76 = 0; _i76 < _size74; ++_i76) {
          var elem77 = null;
          elem77 = new SmartContractMethod();
          elem77.read(input);
          this.methods.push(elem77);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractDataResult.prototype.write = function(output) {
  ...
  if (this.variables !== null && this.variables !== undefined) {
    ...
    for (var kiter84 in this.variables) {
      if (this.variables.hasOwnProperty(kiter84)) {
        var viter85 = this.variables[kiter84];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i88 = 0; _i88 < _size86; ++_i88) {
          var elem89 = null;
          elem89 = new ByteCodeObject();
          elem89.read(input);
          this.byteCodeObjects.push(elem89);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractCompileResult.prototype.write = function(output) {
  ...
  if (this.byteCodeObjects !== null && this.byteCodeObjects !== undefined) {
    output.writeFieldBegin('byteCodeObjects', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.byteCodeObjects.length);
    for (var iter90 in this.byteCodeObjects) {
      if (this.byteCodeObjects.hasOwnProperty(iter90)) {
        iter90 = this.byteCodeObjects[iter90];
        iter90.write(output);
      }
    }
    output.writeListEnd();
...
TokenTransaction.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter95 in this.params) {
      if (this.params.hasOwnProperty(iter95)) {
        iter95 = this.params[iter95];
        iter95.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i98 = 0; _i98 < _size96; ++_i98) {
          var elem99 = null;
          elem99 = new TokenBalance();
          elem99.read(input);
          this.balances.push(elem99);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenBalancesResult.prototype.write = function(output) {
  ...
  if (this.balances !== null && this.balances !== undefined) {
    ...
    for (var iter100 in this.balances) {
      if (this.balances.hasOwnProperty(iter100)) {
        iter100 = this.balances[iter100];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i103 = 0; _i103 < _size101; ++_i103) {
          var elem104 = null;
          elem104 = new TokenTransfer();
          elem104.read(input);
          this.transfers.push(elem104);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenTransfersResult.prototype.write = function(output) {
  ...
  if (this.transfers !== null && this.transfers !== undefined) {
    ...
    for (var iter105 in this.transfers) {
      if (this.transfers.hasOwnProperty(iter105)) {
        iter105 = this.transfers[iter105];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i108 = 0; _i108 < _size106; ++_i108) {
          var elem109 = null;
          elem109 = new TokenTransaction();
          elem109.read(input);
          this.transactions.push(elem109);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenTransactionsResult.prototype.write = function(output) {
  ...
  if (this.transactions !== null && this.transactions !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
    for (var iter110 in this.transactions) {
      if (this.transactions.hasOwnProperty(iter110)) {
        iter110 = this.transactions[iter110];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i113 = 0; _i113 < _size111; ++_i113) {
          var elem114 = null;
          elem114 = new TokenHolder();
          elem114.read(input);
          this.holders.push(elem114);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenHoldersResult.prototype.write = function(output) {
  ...
  if (this.holders !== null && this.holders !== undefined) {
    ...
    for (var iter115 in this.holders) {
      if (this.holders.hasOwnProperty(iter115)) {
        iter115 = this.holders[iter115];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i118 = 0; _i118 < _size116; ++_i118) {
          var elem119 = null;
          elem119 = new TokenInfo();
          elem119.read(input);
          this.tokens.push(elem119);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokensListResult.prototype.write = function(output) {
  ...
  if (this.tokens !== null && this.tokens !== undefined) {
    ...
    for (var iter120 in this.tokens) {
      if (this.tokens.hasOwnProperty(iter120)) {
        iter120 = this.tokens[iter120];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i123 = 0; _i123 < _size121; ++_i123) {
          var elem124 = null;
          elem124 = new WalletInfo();
          elem124.read(input);
          this.wallets.push(elem124);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
WalletsGetResult.prototype.write = function(output) {
  ...
  if (this.wallets !== null && this.wallets !== undefined) {
    ...
    for (var iter125 in this.wallets) {
      if (this.wallets.hasOwnProperty(iter125)) {
        iter125 = this.wallets[iter125];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i128 = 0; _i128 < _size126; ++_i128) {
          var elem129 = null;
          elem129 = new TrustedInfo();
          elem129.read(input);
          this.writers.push(elem129);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TrustedGetResult.prototype.write = function(output) {
  ...
  if (this.writers !== null && this.writers !== undefined) {
    ...
    for (var iter130 in this.writers) {
      if (this.writers.hasOwnProperty(iter130)) {
        iter130 = this.writers[iter130];
